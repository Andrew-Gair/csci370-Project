...
//void displayTrains(string trainQuery);
          ...
          if(selectInput == "staff" || selectInput == "Staff") {
              ...
              if (selectInput == "train" || selectInput == "Train") {
                  ...
                  cout
                          ...
                          << endl;
                  cout
                          << "| EmpNum |      Lname      |      Fname      |  Position  | StationID |      StationName     |"
                          << endl;
                  cout
                          << "+--------+-----------------+-----------------+------------+-----------+----------------------+"
                          << endl;
...
//do error checking on trainSearch here, check to ensure trainID is from the table
