    ...
    while(userInput != "q") {
      ...
      if (userInput == "q" || userInput == "Q") {
        ...
        cout << "please specify what to select from:" << endl
             << "trainStaff, stationStaff, trains, stops [trainID required], routesThrough" << endl;
        getline(cin, userInput);

        //---------------------//
        //--SELECT TRAINSTAFF--//
        if (userInput == "trainStaff") {

          Statement *stmt = conn->createStatement(trainStaffQ);
          //cout << "made statement for trainStaff" << endl;
          ResultSet *rs = stmt->executeQuery();
          //cout << "made result Set for trainStaff" << endl;
          cout << "+--------+-----------------+-----------------+------------+-----------+" << endl;
          ...
          //-----------------------//
          //--SELECT STATIONSTAFF--//
        else if (userInput == "stationStaff") {
        ...
        else if (userInput == "stops") {
          string trainSearch;
          cout << "please enter a valid trainID to look for:" << endl;
          getline(cin, trainSearch);
          string stopsAtQ = stopsQ + trainSearch + "'";
          Statement *stmt = conn->createStatement(stopsQ);
        ...
        else if (userInput == "routesThrough") {

          Statement *stmt = conn->createStatement(routesThroughQ);
